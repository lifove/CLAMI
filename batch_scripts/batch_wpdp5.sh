...
java -cp $libs hk.ust.cse.ipam.utils.SimpleWithinPredictor $dataPath/Relink/Apache.arff isDefective TRUE Apache $mlAlg NoN $repeat $folds >  wpdp/$mlAlg\_Apache_wpdp.txt

java -cp $libs hk.ust.cse.ipam.utils.SimpleWithinPredictor $dataPath/Relink/Safe.arff isDefective TRUE  Safe $mlAlg NoN $repeat $folds >  wpdp/$mlAlg\_Safe_wpdp.txt 

java -cp $libs hk.ust.cse.ipam.utils.SimpleWithinPredictor $dataPath/Relink/Zxing.arff isDefective TRUE  Zxing $mlAlg NoN $repeat $folds >  wpdp/$mlAlg\_Zxing_wpdp.txt
